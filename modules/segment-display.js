...
SegmentDisplay.prototype.drawDigit = function(context, xPos, mask, c) {
  switch (mask) {
    case '#':
      ...
      x = xPos;
      y = 0;
	  // CHANGE: I changed this to include the serif on the 7. -Alden
      //context.fillStyle = this.getSegmentColor(c, '045689abcefhlpty', '045689acefghklmnopqrsuvwy@', '%');
      context.fillStyle = this.getSegmentColor(c, '0456789abcefhlpty', '045689acefghklmnopqrsuvwy@', '%');
      context.beginPath();
...
// I added the following to allow me to import this as a module:
Object.freeze(SegmentDisplay);
